...
Pod::Spec.new do |s|
  ...
  s.name         = "CJWUtilsS"
  s.version      = "3.0.0"
  s.summary      = "CJWUtilsPro is sort of tools for iOS develop written by swift"
  ...
  s.source       = { :git => "https://git.oschina.net/cjw/cjwutilspro.git"  }
...
#s.resources = ["CJWUtilsS/QPLib/Lib/MLEmoji/Expression/*.png"]
  ...
  s.requires_arc = true
  s.resource     = "CJWUtilsPro/QPLib/Lib/MLSelectPhoto/MLSelectPhoto.bundle"
